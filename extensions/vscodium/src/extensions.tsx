...
import type { Extension } from "./lib/vscodium";
import { getLocalExtensions } from "./lib/vscodium";
import {
...
function OpenExtensionInVSCodiumAction(props: { extension: Extension }): JSX.Element {
  return <OpenExtensionByIDInVSCodiumAction extensionID={props.extension.id} />;
}
  ...
  return (
    <List.Item
      ...
      actions={
        <ActionPanel>
          <ActionPanel.Section>
            <OpenExtensionInVSCodiumAction extension={e} />
